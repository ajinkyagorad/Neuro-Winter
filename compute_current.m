...
function[final_current] = compute_current(weight,current_i, previous_time, current_time, spiking_pixels,tau_leak)
    ...
    final_current = current_i.*exp((previous_time - current_time)/tau_leak) + weights_to_be_concerned;
